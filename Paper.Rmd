...
p + annotate("text", x=last_year, y=ridership_data$PredictedBusROC[ridership_data$Year == last_year], label="Predicted Bus Linear", color="blue", hjust=1.1, vjust=6) +
  ...
  annotate("text", x=last_year, y=ridership_data$PredictedRailROC_poly[ridership_data$Year == last_year], label="Predicted Rail Quadratic", color="darkgreen", hjust=1.1, vjust=10)
```
